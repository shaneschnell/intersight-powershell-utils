...
# Create Bios Policy
#================================================================================================
$policyName = 'M6-BIOS-CPU-Intensive'
$policyDescription = 'M6 CPU Intensive Bios Policy'
...
try {
    ...
    $policy.CpuPerfEnhancement = 'Auto'
    $policy.ImcInterleave = '_1WayInterleave'
    $policy.LlcAlloc = 'Disabled'
    $policy.LlcPrefetch = 'Disabled'
    $policy.MemoryRefreshRate = '_1xRefresh'
    $policy.PatrolScrub = 'Disabled'
    $policy.ProcessorC1e = 'Enabled'
    $policy.ProcessorC6report = 'Enabled'
    $policy.SelectMemoryRasConfiguration = 'MaximumPerformance'
    $policy.Snc = 'Enabled'
    $policy.StreamerPrefetch = 'Disabled'
    $policy.UfsDisable = 'Disabled'
    $policy.UpiLinkEnablement = '1'
    $policy.UpiPowerManagement = 'Enabled'
    $policy.WorkLoadConfig = 'Balanced'
    $policy.XptPrefetch = 'Enabled'
