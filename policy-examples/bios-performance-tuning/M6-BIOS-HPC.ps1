...
# Create Bios Policy
#================================================================================================
$policyName = 'M6-BIOS-HPC'
$policyDescription = 'M6 High Performance Computing Bios Policy'
...
try {
    ...
    $policy.IntelVirtualizationTechnology = 'Disabled'
    $policy.IntelVtForDirectedIo = 'Disabled'
